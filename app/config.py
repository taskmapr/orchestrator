...
SUPABASE_DB_DISABLED = _env_flag("SUPABASE_DB_DISABLED") or _env_flag("DISABLE_SUPABASE_DB")
SUPABASE_DB_URL = os.environ.get("SUPABASE_DB_URL", "")
if not SUPABASE_DB_URL:
    if not SUPABASE_DB_DISABLED:
        raise RuntimeError(
            "SUPABASE_DB_URL is required unless SUPABASE_DB_DISABLED is set."
        )
else:
...
if SUPABASE_DB_URL and "postgresql://" in SUPABASE_DB_URL and "postgresql+asyncpg://" not in SUPABASE_DB_URL:
